...
impl BagOfApples {
    ...
    pub fn initialize(mut self: Pin<&mut Self>) {
        ...
        // is safe to store the pointer. We have also reviewed the code
        // to ensure that we do not move the BagOfApples instance via the
        // reference we obtain from here nor via the pointer.
...
// pub fn example_with_pinned_set_capacity() {
...
pub fn example_with_wild_childhood_set_capacity() {
...
fn main() {
    example_with_wild_childhood_set_capacity();
}
